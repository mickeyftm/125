...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://www.kdm.network" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://www.kdm.network" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
