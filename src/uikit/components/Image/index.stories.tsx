...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://www.kdm.network/images/tokens/${token.address[56]}.svg`
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://www.kdm.network/images/tokens/${token.address[56]}.svg`
        const secondarySrc = `https://www.kdm.network/images/tokens/${tokens[randomTokenIndex].address[56]}.svg`
